...
<%@ Page Title="TrackTracer"  Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SzczegolyProjektu.aspx.cs" Inherits="Tracktracer.SzczegolyProjektu" %>
            ...
            <asp:AccordionPane ID="AccordionPane1" runat="server">
                ...
                <Content>
                    ...
                    <asp:Table ID="Table1" runat="server" Height="113px">
                        ...
                        <asp:TableRow runat="server">
                            <asp:TableCell runat="server">SVN: </asp:TableCell>
                            <asp:TableCell runat="server" ForeColor="Black">
                            <asp:HyperLink ID="svn_Link" runat="server" Target="_blank"></asp:HyperLink>
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                    <br />
                    <asp:Button ID="produkt_Button" runat="server" Text="Rejestr produktowy" 
                        onclick="produkt_Button_Click" />
                &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="pliki_Button" runat="server" Text="Pliki" 
                        onclick="pliki_Button_Click" />
                &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="testy_Button" runat="server" Text="Przypadki testowe" 
                        onclick="testy_Button_Click" />
                    &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="svn_Button" runat="server" onclick="svn_Button_Click" 
                        Text="Edytuj dane SVN" Visible="False" />
                    <br />                    
                    <br />
                &nbsp;<asp:Label ID="Label4" runat="server" Text="Wydanie: "></asp:Label>
                    <asp:DropDownList ID="wydanie_DropDownList" runat="server" 
                        ...
                        DataValueField="nr_wydania" AutoPostBack="True" 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                        ...
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="wydanie_DropDownList" DefaultValue="" 
                                Name="nr_wyd" PropertyName="SelectedValue" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <br />
                    <br />
                    <asp:Button ID="zadaniowy_Button" runat="server" Text="Rejestr zadaniowy" 
                        onclick="zadaniowy_Button_Click" />
                    <br />
                </Content>
            </asp:AccordionPane>
            ...
            <asp:AccordionPane ID="AccordionPane3" runat="server">
                ...
                <Content>                    
                    ...
                    <asp:DropDownList ID="wydanie2_DropDownList" runat="server" 
                        DataSourceID="SqlDataSource4" DataTextField="nr_wydania" 
